...
It analyzes OD data from Enzyscreen from a `.csv` file and generates an XML file for the Momentum Thermo Scientific system when a specified growth criterion is met.
